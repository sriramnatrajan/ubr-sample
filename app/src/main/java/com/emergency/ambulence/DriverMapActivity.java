...
TextView mAccidentType,userFeedBack;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAccidentType=(TextView)findViewById(R.id.accidentType);
        ...
        userFeedBack=(TextView)findViewById(R.id.userFeedBack);
    ...
    private void getAssignedCustomerInfo(){
        ...
        DatabaseReference mDatabaseReference1=FirebaseDatabase.getInstance().getReference("accident");
    ...
    private void endRide(){
        ...
        mCustomerDestination.setText("Destination: Nearest Hospital");
    ...
    public void textFeed(){
        DatabaseReference mDatabaseReference2=FirebaseDatabase.getInstance().getReference("feedback");
        mDatabaseReference2.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                fdText = dataSnapshot.child("feedbackText").getValue(String.class);
                // String number = dataSnapshot.child("typeAccident").getValue(String.class);
...
public void feedback(){
            ...
            View promptsView = li.inflate(R.layout.feedbackresult, null);

            AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(
                    context);
            alertDialogBuilder.setView(promptsView);

            final TextView   feedText = (TextView) promptsView.findViewById(R.id.feedResult);

            feedText.setText(fdText);
