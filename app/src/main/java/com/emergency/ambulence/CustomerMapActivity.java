...
import com.emergency.ambulence.historyRecyclerView.Feedback;
...
public class CustomerMapActivity extends FragmentActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, com.google.android.gms.location.LocationListener {
        ...
        mFloatingActionButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    final Spinner spinner = (Spinner) promptsView.findViewById(R.id.spinner_id);
                     ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(context,
                            R.array.planets_array, android.R.layout.simple_spinner_item);
                     adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
                     mDatabaseReference=FirebaseDatabase.getInstance().getReference("accident");
                            ...
                            .setPositiveButton("OK",
                                    new DialogInterface.OnClickListener() {
                                        public void onClick(DialogInterface dialog, int id) {
                                            ...
                                            // edit text
                                         /*   peoples=userInput.getText().toString().trim();
                                            if (!TextUtils.isEmpty(peoples)){

                                                Toast.makeText(context, "fill data to proceed", Toast.LENGTH_SHORT).show();
                                            } else {*/
                                               peoples=userInput.getText().toString().trim();
                                               accidentType=spinner.getSelectedItem().toString();
                                               String i= mDatabaseReference.push().getKey();
                                                Accident mAccident=new Accident(i,peoples,accidentType);
                                                mDatabaseReference.setValue(mAccident);
                                                Toast.makeText(context, "Accident detail sent", Toast.LENGTH_SHORT).show();
        ...
        driverLocationRefListener = driverLocationRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists() && requestBol) {
                    ...
                    if (distance < 100) {
                        ...
                        NotificationCompat.Builder builder =
                                new NotificationCompat.Builder(context)
                                        ...
                                        .setContentTitle("Ambulance is Here")
                                        .setContentText("Ambulance is Arrived");

                        Intent notificationIntent = new Intent(context, CustomerMapActivity.class);
                    ...
                    mDriverMarker = mMap.addMarker(new MarkerOptions().position(driverLatLng).title("your Ambulance").icon(BitmapDescriptorFactory.fromResource(R.mipmap.ic_car)));
                }
    ...
    *-------------------------------------------------------------------*/
    ...
    private void endRide() {
        ...
        mDriverCar.setText("Destination: Hospital");
        ...
        alertDialogBuilder.setCancelable(false)
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        mDatabaseReference=FirebaseDatabase.getInstance().getReference("feedback");

                            String idvalue= mDatabaseReference.push().getKey();
                            Feedback mFeedback=new Feedback(idvalue,feedback);
                            mDatabaseReference.setValue(mFeedback);
                            Toast.makeText(context, "Feeedback detail sent", Toast.LENGTH_SHORT).show();
